...
http_response "$lan_ip@$koolshare_version@$origin_exists@$config_exists@$clash_allow_lan@$clash_ext_controller@$clash_dns_enable@$clash_dns_ipv6@$clash_dns_mode@$clash_dns_listen@$fallbackdns@$iptables_mangle@$iptables_nat@$iptables_mangle_clash@$iptables_nat_clash@$clash_redir"
